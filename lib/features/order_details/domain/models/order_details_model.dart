...
class OrderDetailsModel {
  ...
  OrderDetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    // variation = json['variation'] is List ? Variation.fromJson(json['variation']) : json['variation'];
 if (json['variation'] != null) {
  if (json['variation'] is List) {
    variation = (json['variation'] as List).isNotEmpty
      ? (json['variation'][0]['_type'] as String?)  // Assuming there's a string property in the variation
      : null;
  } else if (json['variation'] is Map<String, dynamic>) {
    // If json['variation'] is a Map, extract the necessary string
    Variation varObj = Variation.fromJson(json['variation']);
    variation = varObj._type;  // Replace this with actual string field from Variation object
  } else {
