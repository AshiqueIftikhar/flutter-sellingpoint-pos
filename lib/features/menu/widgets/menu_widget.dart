              ...
              return Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 16), // Adds spacing between the GridView and the text
                    const Text(
                      "Powered by Moulik Solutions", // Add your desired text
                      style: TextStyle(fontSize: 10, color: Color.fromARGB(255, 92, 97, 95)), // Adjust text style if needed
                    ),
                  ],
                )
              );
