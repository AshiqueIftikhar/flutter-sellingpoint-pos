                          ...
                          Row(children: [
                            ...
                            Expanded(flex: 8,child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              CustomText(amount: widget.productModel!.discount, isLocale: false,
                                  ...
                                  amountValue: widget.productModel!.discountType == 'flat',
                                  isPercentage: widget.productModel!.discountType == 'percent'),
                              widget.productModel!.productType == 'physical'?
                              CustomText(title: widget.productModel!.productType == 'physical'? widget.productModel!.productQty.toString() : getTranslated('digital', context), isLocale: false,):const SizedBox(),
